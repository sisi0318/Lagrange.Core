...
[Serializable]
public class OneBotGetMessageResponse(DateTime time, string messageType, int messageId, OneBotSender sender, List<OneBotSegment> message, ulong seq, uint appid = 0)
{
    ...
    [JsonPropertyName("seq")] public ulong Seq { get; set; } = seq;
